 ...
 */
class PhpposEmployeesResetPassword extends \principalBundle\Entity\PhpposEmployeesResetPassword implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'principalBundle\\Entity\\PhpposEmployeesResetPassword' . "\0" . 'key', '' . "\0" . 'principalBundle\\Entity\\PhpposEmployeesResetPassword' . "\0" . 'expire', '' . "\0" . 'principalBundle\\Entity\\PhpposEmployeesResetPassword' . "\0" . 'id', '' . "\0" . 'principalBundle\\Entity\\PhpposEmployeesResetPassword' . "\0" . 'employee'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (PhpposEmployeesResetPassword $proxy) {
