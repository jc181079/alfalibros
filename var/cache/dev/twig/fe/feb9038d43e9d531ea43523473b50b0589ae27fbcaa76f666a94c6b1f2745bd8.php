...
class __TwigTemplate_224602739e2294e1c44397e975e4f3e6f19c9842637e46aeb2210477d6ffb025 extends Twig_Template
{
    ...
    ";
        ...
        if (array_key_exists("redirect_handler", $context)) {
            ...
            echo "
                        (<a href=\"";
            // line 81
            echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getPath("_profiler", array("token" => $this->getAttribute($this->getAttribute((isset($context["collector"]) ? $context["collector"] : null), "redirect", array()), "token", array()))), "html", null, true);
            echo "\">";
        ...
        if (array_key_exists("forward_handler", $context)) {
            ...
            echo "
                        (<a href=\"";
            // line 93
            echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getPath("_profiler", array("token" => $this->getAttribute($this->getAttribute((isset($context["collector"]) ? $context["collector"] : null), "forward", array()), "token", array()))), "html", null, true);
            echo "\">";
...
";
    ...
    {
        return new Twig_Source("", "@WebProfiler/Collector/request.html.twig", "C:\\xampp\\htdocs\\alfalibros\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\WebProfilerBundle\\Resources\\views\\Collector\\request.html.twig");
    }
}
