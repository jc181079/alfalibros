 ...
 */
class PhpposLocationItemsTierPrices extends \principalBundle\Entity\PhpposLocationItemsTierPrices implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'principalBundle\\Entity\\PhpposLocationItemsTierPrices' . "\0" . 'unitPrice', '' . "\0" . 'principalBundle\\Entity\\PhpposLocationItemsTierPrices' . "\0" . 'percentOff', '' . "\0" . 'principalBundle\\Entity\\PhpposLocationItemsTierPrices' . "\0" . 'item', '' . "\0" . 'principalBundle\\Entity\\PhpposLocationItemsTierPrices' . "\0" . 'location', '' . "\0" . 'principalBundle\\Entity\\PhpposLocationItemsTierPrices' . "\0" . 'tier'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (PhpposLocationItemsTierPrices $proxy) {
