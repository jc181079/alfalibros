 ...
 */
class PhpposPermissionsActions extends \principalBundle\Entity\PhpposPermissionsActions implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'principalBundle\\Entity\\PhpposPermissionsActions' . "\0" . 'action', '' . "\0" . 'principalBundle\\Entity\\PhpposPermissionsActions' . "\0" . 'person', '' . "\0" . 'principalBundle\\Entity\\PhpposPermissionsActions' . "\0" . 'module'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (PhpposPermissionsActions $proxy) {
