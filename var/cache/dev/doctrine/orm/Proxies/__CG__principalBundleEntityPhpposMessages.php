 ...
 */
class PhpposMessages extends \principalBundle\Entity\PhpposMessages implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'principalBundle\\Entity\\PhpposMessages' . "\0" . 'message', '' . "\0" . 'principalBundle\\Entity\\PhpposMessages' . "\0" . 'createdAt', '' . "\0" . 'principalBundle\\Entity\\PhpposMessages' . "\0" . 'deleted', '' . "\0" . 'principalBundle\\Entity\\PhpposMessages' . "\0" . 'id', '' . "\0" . 'principalBundle\\Entity\\PhpposMessages' . "\0" . 'sender'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (PhpposMessages $proxy) {
