 ...
 */
class PhpposSessions extends \principalBundle\Entity\PhpposSessions implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'principalBundle\\Entity\\PhpposSessions' . "\0" . 'ipAddress', '' . "\0" . 'principalBundle\\Entity\\PhpposSessions' . "\0" . 'timestamp', '' . "\0" . 'principalBundle\\Entity\\PhpposSessions' . "\0" . 'data', '' . "\0" . 'principalBundle\\Entity\\PhpposSessions' . "\0" . 'id'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (PhpposSessions $proxy) {
