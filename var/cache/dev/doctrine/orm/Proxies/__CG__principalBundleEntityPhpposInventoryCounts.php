 ...
 */
class PhpposInventoryCounts extends \principalBundle\Entity\PhpposInventoryCounts implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'principalBundle\\Entity\\PhpposInventoryCounts' . "\0" . 'countDate', '' . "\0" . 'principalBundle\\Entity\\PhpposInventoryCounts' . "\0" . 'status', '' . "\0" . 'principalBundle\\Entity\\PhpposInventoryCounts' . "\0" . 'comment', '' . "\0" . 'principalBundle\\Entity\\PhpposInventoryCounts' . "\0" . 'id', '' . "\0" . 'principalBundle\\Entity\\PhpposInventoryCounts' . "\0" . 'location', '' . "\0" . 'principalBundle\\Entity\\PhpposInventoryCounts' . "\0" . 'employee'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (PhpposInventoryCounts $proxy) {
    ...
    public function setCountDate($countDate)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setCountDate', [$countDate]);

        return parent::setCountDate($countDate);
    }
    ...
    public function getCountDate()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getCountDate', []);

        return parent::getCountDate();
    }
